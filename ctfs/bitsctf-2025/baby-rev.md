---
description: Just a little obfuscation to start
---
...
To Solve this challenge, I went on google and looked for a script made for deobuscating "freecodingtools" obfuscated code.

{% embed url="https://github.com/admin-else/freedecodingtoolspy" %}

Installing the tool and using the command:

```
freedecodingtoolspy chall.py -o result
cat result
```

<pre><code><strong># Online Python Compiler
</strong>
print("Hello, World!")
